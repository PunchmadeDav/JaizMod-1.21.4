...
public class DynamiteItem extends Item implements ProjectileItem {
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        if (world instanceof ServerWorld serverWorld) {
            ProjectileEntity.spawnWithVelocity(DynamiteEntity::new, serverWorld, itemStack, user, 0.0F, 1.0f, 1.0F);
        }
    ...
    public ProjectileEntity createEntity(World world, Position pos, ItemStack stack, Direction direction) {
        return new DynamiteEntity(world, pos.getX(), pos.getY(), pos.getZ(), stack);
    }
