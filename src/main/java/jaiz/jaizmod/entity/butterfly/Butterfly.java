...
public class Butterfly extends EntityModel<ButterflyRenderState> {
	...
	@Override
	public void setAngles(ButterflyRenderState entity) {
		super.setAngles(entity);
		this.getPart().traverse().forEach(ModelPart::resetTransform);
		this.animate(entity.flyingAnimationState, PlantsAndJunkModAnimations.BUTTERFLY, entity.age);
		this.animate(entity.idleAnimationState, PlantsAndJunkModAnimations.BUTTERLY_IDLE, entity.age);
	}
