...
public class SnifferBlossomFeatureRenderer extends FeatureRenderer<SnifferEntityRenderState, SnifferEntityModel> {
    public SnifferBlossomFeatureRenderer(FeatureRendererContext<SnifferEntityRenderState, SnifferEntityModel> context) {
        super(context);
    }

    private static final Identifier TEXTURE = Identifier.ofVanilla("textures/entity/sniffer/cherry_blossom.png");
